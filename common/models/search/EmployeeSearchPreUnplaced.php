 ...
 */
class EmployeeSearchPreUnplaced extends Employee
{
    ...
    public function search($params)
    {
        ...
        $latest_placements_unplaced = ArrayHelper::getColumn(LatestPlacement::find()->select('employee_id')->asArray()->all(), 'employee_id');
        $query->where(['in', 'employee.id', $uncontracted_employees]);
        $query->andWhere(['not in', 'employee.id', $latest_placements_unplaced]);
