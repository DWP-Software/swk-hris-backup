 ...
 */
class EmployeeSearchPreWaiting extends Employee
{
    ...
    public function search($params)
    {
        ...
        $latest_placements_unplaced = ArrayHelper::getColumn(LatestPlacement::find()->select('employee_id')->where(['response_type' => Placement::RESPONSE_WAITING])->asArray()->all(), 'employee_id');
