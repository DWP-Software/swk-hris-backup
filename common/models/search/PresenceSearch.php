...
class PresenceSearch extends Presence
{
    ...
    {
        return [
            [['id', 'employee_id', 'started_at', 'ended_at', 'is_late', 'overtime_started_at', 'overtime_ended_at', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
            [['date', 'status'], 'safe'],
    ...
    public function search($params)
    {
        ...
        if (Yii::$app->user->can('Kehadiran')) {
            $query->joinWith(['employee.latestContractPlacement.contractPlacement.client.picClients'])->where(['pic_client.user_id' => Yii::$app->user->id, 'role' => 'Kehadiran']);
        }
