...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return 'CRUD Generator for AdminLTE bootstrap theme with <code>kartik\widgets\Select2</code> and <code>kartik\widgets\DatePicker</code>.';
    }
    ...
    public function getNameAttribute()
    {
        foreach ($this->getColumnNames() as $name) {
            if (!strcasecmp($name, 'name') || !strcasecmp($name, 'title') || !strcasecmp($name, 'serial') || !strcasecmp($name, 'key') || !strcasecmp($name, 'username')) {
                return $name;
            }
        }
    ...
    public function generateColumnFormat($column)
    {
        if ($column->phpType === 'boolean') {
            ...
            return 'integer';
        } elseif ($column->phpType === 'double') {
            return 'decimal';
        } elseif ($column->phpType === 'date') {
            return 'date';
        } else {
            return 'text';
        }
