...
$this->params['breadcrumbs'][] = ['label' => 'Employee', 'url' => ['index-pre']];
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <?= $model->placementPlans || $model->contracts ? null : '<p>'. Html::a('<i class="glyphicon glyphicon-trash"></i> ' . 'Delete', ['delete-pre', 'id' => $model->id], [
