...
<div class="presence-index box-- box-primary-- box-body--">
    ...
    <?php Pjax::begin(); ?>    <?php 
        ...
        $gridColumns = [
            ...
            [
                ...
                // 'filter' => ArrayHelper::map(Employee::find()->joinWith(['contracts'])->where(['is not', 'contract.id', null])->orderBy('name')->all(), 'id', 'shortText'), 
                'filter' => $data, 
    ...
    <?= GridView::widget([
        ...
        'bordered' => false,
        'toolbar'=> [
            Html::a('<i class="fa fa-plus"></i> ' . 'Input Perorangan', ['create'], ['class' => 'btn btn-default']),
            Html::a('<i class="fa fa-plus"></i> ' . 'Input Harian', ['create-daily'], ['class' => 'btn btn-default']),
            Html::a('<i class="fa fa-upload"></i> ' . 'Import dari Excel', ['import'], ['data-pjax'=>0, 'class'=>'btn btn-default']),
            Html::a('<i class="fa fa-repeat"></i> ' . 'Reload', ['index'], ['data-pjax'=>0, 'class'=>'btn btn-default']),
            '{toggleData}',
            // $exportMenu,
            Html::a('<i class="fa fa-th"></i> ' . 'Report', ['report'], ['data-pjax'=>0, 'class'=>'btn btn-default']),
        ],
        'panel' => [
