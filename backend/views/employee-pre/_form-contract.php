    ...
    <div class="col-md-4">
        <div class="detail-view-container" style="margin-bottom:10px">
            ...
            <div style="padding:10px;">
                ...
                <div class="detail-view-container box-body" style="margin-bottom:5px; background: #f4f4f4; display:none">
        ...
        <div class="detail-view-container" style="margin-bottom:10px">
            <h5 style="background:#f4f4f4;padding:10px;margin:0">PENEMPATAN AWAL</h5>
            <div style="padding:10px;">
                
                <?= $form->field($modelPlacement, 'client_id')->widget(Select2::classname(), [
                    'data' => ArrayHelper::map(Client::find()->all(), 'id', 'name'),
                    'options' => ['placeholder' => ''],
                    'pluginOptions' => ['allowClear' => true],
                ]); ?>

                <?= $form->field($modelPlacement, 'position')->textInput(['maxlength' => true]); ?>
                <?= $form->field($modelPlacement, 'location')->textInput(['maxlength' => true]); ?>
                <?= $form->field($modelPlacement, 'department')->textInput(['maxlength' => true]); ?>

                <?= $form->field($modelPlacement, 'started_at')->widget(DatePicker::classname(), [
                    'type' => DatePicker::TYPE_COMPONENT_PREPEND,
                    // 'readonly' => true,
                    'pluginOptions' => ['autoclose' => true, 'format' => 'yyyy-mm-dd'],
                ]); ?>

                <?= $form->field($modelPlacement, 'ended_at')->widget(DatePicker::classname(), [
                    'type' => DatePicker::TYPE_COMPONENT_PREPEND,
                    // 'readonly' => true,
                    'pluginOptions' => ['autoclose' => true, 'format' => 'yyyy-mm-dd'],
                ]); ?>
                        ...
                        foreach (ContractSalary::permanentTypes($type_key) as $subtype_key => $subtype_value) {
                            ?>
                                <div class="form-group">
                                    ...
                                    <?= Html::textInput($subtype_value, null, ['class' => 'form-control', 'id' => Inflector::slug($subtype_value)]) ?>
                                </div>
                            <?php
                        }
