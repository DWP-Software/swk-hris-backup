...
<?= $form->field($modelEducation, 'level')->dropDownList(Employee::educationLevels(), ['class' => 'form-control', 'prompt' => '']) ?>
...
<?= $form->field($modelEducation, 'major')->textInput(['class' => 'form-control', 'maxlength' => true]) ?>
<?php // echo $form->field($modelEducation, 'remark')->textInput(['class' => 'form-control', 'maxlength' => true]) ?>
