    ...
    <?php Pjax::begin(); ?>    <?php 
        ...
        $gridColumns = [
            ...
            [
                ...
                'template' => '{view} {impersonate}',
                'buttons' => [
                    'view' => function ($url) {
                        return Html::a('', $url, ['class' => 'glyphicon glyphicon-eye-open btn btn-xs btn-default btn-text-info', 'data-pjax' => 0]);
                    },
                    'impersonate' => function ($url) {
                        return Html::a('', $url, [
                            'class' => 'glyphicon glyphicon-user btn btn-xs btn-default btn-text-success', 
                            'data-method' => 'post', 
                            'data-confirm' => 'Are you sure you want to impersonate this user?', 'data-pjax' => 0]);
                    },
                ],
            ],
            // 'id',
