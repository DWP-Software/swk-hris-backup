    ...
    <?php Pjax::begin(); ?>    <?php 
        ...
        $gridColumns = [
            ...
            [
                ...
                'format' => 'html',
                'value' => function($model) {
                    return $model->contract->contractPlacements[0] 
                    ? $model->contract->contractPlacements[0]->id
                        // . ' - ' . $model->contract->contractPlacements[0]->placement->client->name
                        . ' : <small class="text-muted">' . $model->contract->contractPlacements[0]->started_at . ' s.d ' . $model->contract->contractPlacements[0]->ended_at . '</small>'
                    : null;
                }
            ]
            // [
