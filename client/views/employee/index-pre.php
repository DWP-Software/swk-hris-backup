    ...
    <?php Pjax::begin(); ?>    <?php 
        ...
        $gridColumns = [
            ...
            [
                ...
                'format'              => 'html',
                'value'               => function($model) {
                    return ($model->latestPlacement ? $model->latestPlacement->client->name : '') .'<br><span class="text-muted">' . ($model->latestPlacement ? $model->latestPlacement->responseTypeText : '') . '</span>';
                },
